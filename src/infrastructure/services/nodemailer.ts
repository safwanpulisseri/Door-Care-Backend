      ...
      const mailOptions = {
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
          <div style="text-align: center; margin-bottom: 20px;">
            <h2>Hello ${name}, Welcome to <strong>Door Care</strong>!</h2>
    ...
    try {
      ...
      const acceptMailOptions = {
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
          ...
          <div style="margin-bottom: 20px;">
            <p>Dear ${name},</p>
            <p>Congratulations! Your application to join Door Care has been accepted.</p>
            ...
            <p>Your journey with Door Care starts now. We look forward to working together and creating great experiences for our users.</p>
      ...
      const rejectMailOptions = {
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
          ...
          <div style="margin-bottom: 20px;">
            <p>Dear ${name},</p>
            <p>We regret to inform you that your application for joining Door Care has been rejected.</p>
